...
# в котором каждая строка должна 
# содержать данные о фирме: 
# название, 
# форма собственности, 
# выручка, 
# издержки.
...
# вычислить прибыль каждой компании, а также 
# среднюю прибыль.
...
file_r = os.path.join(DIR, 'task7.txt')
file_j = os.path.join(DIR, 'task7.json')
...
with open(file_j, 'w', encoding='utf-8') as file_write:
